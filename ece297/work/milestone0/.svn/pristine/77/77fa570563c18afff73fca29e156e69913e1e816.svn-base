...
int main() {
    ...
    Polynomial *g= new Polynomial(1,1,2,2,3,3);
    ...
    Coordinates center_of_mass_of_g= compute_center_of_mass(*g,5,5,5);
    //print out center of mass
    cout << setprecision(4) << "center of mass (x,y,z) = " << center_of_mass << endl;
    cout << setprecision(4) << "center of mass (x,y,z) = " << center_of_mass_of_g<< endl;
